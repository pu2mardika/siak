	...
	<div id="x_panel" class="container-fluid">	
		<section class="row">
			<div class=" mainav">
		        ...
		        <?php			
					echo $this->fungsi->ajx_link("akademik/testtt","#x_panel",
					 $this->lang->line('ico_trash-o').' '.$this->lang->line('trash'),
						 'class="btn btn-default btn-sm" title="'.$this->lang->line('trash').'"');
					
					echo $this->fungsi->ajx_link("akademik/add_curr","#x_panel",
