...
class Tendik extends BaseConfig
{
	...
	*/
	public $fields = [
		...
		'noid'			=> ['label' => 'NIP','width'=>6,'extra'=>['class' => '', 'required' => true],'type'=>'text', ], 		 
		...
		'status'		=> ['label' => 'Status Perkawinan','width'=>0, 'extra'=>['class' => '', 'required' => true],'type'=>'dropdown'], 
		'sts_kepeg'		=> ['label' => 'Status Kepegawaian','width'=>0, 'extra'=>['class' => '', 'required' => true],'type'=>'dropdown'], 
		...
		'npwp'			=> ['label' => 'NPWP','width'=>12, 'extra'=>['class' => '', 'required' => false],'type'=>'text'], 
		'rekeningbank'	=> ['label' => 'No. Rekening','width'=>0, 'extra'=>['class' => '', 'required' => true],'type'=>'text'], 
		'namabank'		=> ['label' => 'Nama Bank','width'=>0, 'extra'=>['class' => '', 'required' => true],'type'=>'text'], 
		'holdname'		=> ['label' => 'Nama Pemilik Rek','width'=>0, 'extra'=>['class' => '', 'required' => true],'type'=>'text'], 
		'tmt'			=> ['label' => 'TMT Tugas','width'=>0, 'extra'=>['class' => '', 'required' => true],'type'=>'date'],
	];
