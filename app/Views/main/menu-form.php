...
<div class="card">
	...
	<div class="card-body">
		<a href="<?=base_url()."/menu/add";?>" class="btn btn-success btn-xs" id="add-menu"><i class="fa fa-plus pr-1"></i> Tambah Menu</a>
		<hr/>
		...
		<span style="display:none" id="url-delete"><?=base_url() . 'menu/delete'?></span>
		<span style="display:none" id="url-edit"><?=base_url() . 'menu/edit'?></span>
		<span style="display:none" id="url-detail"><?=base_url() . 'menu/menuDetail?ajax=true&id='?></span>
	</div>
</div>
<?= $this->endSection() ?>