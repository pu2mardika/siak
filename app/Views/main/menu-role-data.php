  ...
  <div class="card">
	...
	<div class="card-body">
		...
		if (!$data_menu) {
			...
			foreach ($data_menu as $key => $val) 
			{
				...
				echo '<tr>
						...
						<td>
							...
							<a data-id-menu="'.$val['id_menu'].'" href="' . base_url() . '/menu-role/edit?id=' . $val['id_menu'] .'" class="btn btn-success btn-xs mr-1 role-edit"><i class="fa fa-edit"></i>&nbsp;Edit</a>
							</div>
						</td>
					</tr>';
				$no++;
			...
			<span style="display:none" id="url-delete"><?=base_url() . '/menu-role/delete'?></span>
			</div>
			<?php 
		} ?>
