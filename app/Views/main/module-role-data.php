				...
				echo '<tr>
						...
						<td>
							<div class="btn-action-group">
								<a data-pair-id="'.$val['id_module'].'" href="' . base_url() . '/module-role/edit?id=' . $val['id_module'] .'" class="btn btn-success btn-xs mr-1 role-edit"><i class="fa fa-edit pr-1"></i> Edit</a>
								<a href="' . base_url() . '/module-role/detail?id=' . $val['id_module'] .'" class="btn btn-primary btn-xs mr-1"><i class="fa fa-edit"></i>&nbsp;Detail</a>
							</div>
						</td>
					</tr>';
				$no++;
