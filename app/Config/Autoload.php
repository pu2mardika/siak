...
class Autoload extends AutoloadConfig
{
    ...
    public $psr4 = [
        ...
        'Modules\Tp'          => ROOTPATH. 'modules/Tp',
        'Modules\Pricing'     => ROOTPATH. 'modules/Price',
        'Modules\Billing'     => ROOTPATH. 'modules/Billing',
        'ThemeViews'   	  	  => ROOTPATH. 'themes',
        'Raport'   	  		  => ROOTPATH. 'template/data-raport',
     //   'ThemeViews'   	  	  => ROOTDIR. 'themes',
     //   'ThemeViws'   	  	  => FCPATH. 'css',
    ];
     ...
     * @phpstan-var list<string>
     */
    public $helpers = ['html', 'app', 'text', 'util', 'auth', 'setting'];
}
